...
const config = {
  title: 'Petrov Day 39',
  tagline: 'A washifold exclusive event',
  ...
  themeConfig:
    ...
    ({
      navbar: {
        title: 'Wherever you are, whatever you\'re doing, take a minute to not destroy the world',
        logo: {
          alt: 'My Site Logo',
          src: 'img/logo.png',
        },
      ...
      footer: {
        ...
        copyright: `This version built ${new Date()}. Public domain.`,
      },
      prism: {
